...
public class Task3 {
    ...
    public static HashMap<String, String> reader() throws IOException {
        BufferedReader bf = new BufferedReader(new FileReader("C:\\Users\\Dmitry\\Downloads\\Postgraduate studies\\Homework program\\Exception\\Seminar2\\fileForTask3.txt"));
    ...
    public static void writer(HashMap<String, String> hashMap) throws IOException {
        BufferedWriter bw = new BufferedWriter(
                new FileWriter("C:\\Users\\Dmitry\\Downloads\\Postgraduate studies\\Homework program\\Exception\\Seminar2\\fileForTask3_2.txt"));
